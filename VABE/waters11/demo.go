...
type Water11Demo struct {
	Verbose bool
	scheme  Waters11
}

func (B Water11Demo) Setup(setupParams VABE.SetupParams) (VABE.SetupParams, error) {
...
func (B Water11Demo) KeyGen(keyGenParams VABE.KeyGenParams) (VABE.KeyGenResponse, error) {
...
func (B Water11Demo) Encrypt(encryptParams VABE.EncryptParams) (VABE.EncryptResponse, error) {
...
func (B Water11Demo) Decrypt(decryptParams VABE.DecryptParams) (VABE.DecryptResponse, error) {
...
func (B Water11Demo) VerifyKey(verifyKeyParams VABE.VerifyKeyParams) bool {
...
func (B Water11Demo) VerifyCiphertext(verifyCiphertextParams VABE.VerifyCiphertextParams) bool {
...
func NewWater11Demo(verbose bool) *Water11Demo {
	return &Water11Demo{
		Verbose: verbose,
		scheme: Waters11{
			Verbose: verbose,
